...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image('verity', 'assets/flyverity.png');
        this.load.image('tubo', 'assets/tuberia.svg');
    ...
    create() {
        ...
        const radius = Math.min(this.player.width, this.player.height) / 2;
    ...
    addObstaclePair() {
        const gap = 150;
        const holeCenter = Phaser.Math.Between(180, 360);
        const topPipeBottomY = holeCenter - gap / 2;
        const bottomPipeTopY = holeCenter + gap / 2;

        const topObstacle = this.obstacles.create(420, topPipeBottomY, 'tubo');
        topObstacle.setScale(1, 1.5);
        ...
        const bottomObstacle = this.obstacles.create(420, bottomPipeTopY, 'tubo');
        bottomObstacle.setScale(1, 1.5);
        ...
        const topHeight = topPipeBottomY;
        const bottomHeight = 600 - bottomPipeTopY;
        topObstacle.setSize(topObstacle.width, topHeight);
        bottomObstacle.setSize(bottomObstacle.width, bottomHeight);
        topObstacle.body.setSize(topObstacle.width, topHeight);
        bottomObstacle.body.setSize(bottomObstacle.width, bottomHeight);
        topObstacle.body.updateFromGameObject();
        bottomObstacle.body.updateFromGameObject();
